...
public class State implements Comparable<State>
{
	...
	private ArrayList<Integer> rightPersons;	// family members that are on the right side
	private ArrayList<Integer> leftPersons;		// family members that are on the left side
	...
	public State(){
		...
		this.father = null;
		this.lamp = true;
		this.rightPersons = new ArrayList<Integer>();
		this.leftPersons = new ArrayList<Integer>();
	}
